...
export default function EventPage() {
    ...
    return (
        <View className='flex-1 gap-3 bg-white p-3'>
            ...
            <View className='absolute bottom-0 left-0 right-0 flex-row justfy-between border-t-2 border-gray-300 p-5 pb-10'>
                <Text className='text-xl font-semiBold'>Free</Text>

                <Pressable className='rounded-mdbg-pink-500 p-5 px-8'>
